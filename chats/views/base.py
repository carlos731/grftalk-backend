...
from chats.utils.exceptions import UserNotFound, ChatNotFound, MessageAlreadyDeleted
...
class BaseView(APIView):
    ...
    def validate_message_not_deleted(self, message_id, chat_id, user_id):
        message = ChatMessage.objects.filter(
            id=message_id,
            chat_id=chat_id,
            from_user_id=user_id,
            deleted_at__isnull=False  # Verifica se já foi deletada
        ).first()
