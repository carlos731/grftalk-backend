...
class ChatMessagesView(BaseView):
    ...
    def post(self, request, chat_id):
        ...
        if file: 
            ...
            name = file.name.split('.')[0] # arquivo.py -> ['arquivo', 'py']
...
class ChatMessageView(BaseView):
    def delete(self, request, chat_id, message_id):
        ...
        # Validate if the message is not already deleted
        self.validate_message_not_deleted(message_id, chat_id, request.user.id)
